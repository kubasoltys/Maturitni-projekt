...
Díky znalosti těchto základům jsem se mohl při tvorbě maturitního projektu soustředit na komplexnější výzvy, jako je logika docházkového systému, vizualizace výkonnostních dat pomocí grafů nebo funkčnost účtů uživatelů. Počáteční znalost frameworku Django mi tak dala náskok, který byl ve vývoji této aplikace nezbytný.
	...
	Celá aplikace je postavena na programovacím jazyce Python, který je oceňován pro svou vysokou čitelnost, čistou syntaxi a efektivitu vývoje. V projektu slouží jako základní kámen pro veškerou logiku na straně serveru. Python jsem zvolil především kvůli mé znalosti tohoto jazyka z mého studia a rozsáhlému ekosystému knihoven, což mi umožnilo snadno používat pokročilé funkce, jako jsou třeba automatické výpočty statistik docházky.
	...
	\newpage
	\section[Autentizace a autorizace uřivatelů]{Autentizace a autorizace uřivatelů}
	...
	\chapter{Funkční procesy aplikace}
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=0.8\linewidth]{image/zapis_vysledku.png} 
		\caption{Zapisování výsledku}
	\end{figure}
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=0.5\linewidth]{image/vyber_tymu.png} 
		\caption{Výběr týmu}
	\end{figure}
	...
	\chapter{Shrnutí a výsledky práce}
	
	
	\section[Funkce aplikace]{Funkce aplikace}
